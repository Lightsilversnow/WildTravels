...
public class PlayerLocomotion : MonoBehaviour
{
    ...
    private void HandleFallingAndLanding()
    {
        ...
        if (!isGrounded && !isJumping)
        {
            if (!playerManager.isInteracting)
            {
                animatorManager.PlayTargetAnimation("Cat_Falling", true);
            }
        ...
        if (Physics.SphereCast(rayCastOrigin, 0.1f, -Vector3.up, out hit, groundLayer))
        {
            ...
            {
                animatorManager.PlayTargetAnimation("Cat_Land", true);
            }
    ...
    public void HandleJumping()
    {
        if (isGrounded)
        {
            ...
            animatorManager.PlayTargetAnimation("Cat_Jump", false);
